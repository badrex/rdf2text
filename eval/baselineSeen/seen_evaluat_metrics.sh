...
java -Xmx2G -jar meteor-1.5.jar ../baselineSeen/relexicalised_predictions.txt ../baselineSeen/all-notdelex-refs-meteor.txt -l en -norm -r 8
...
java -jar tercom.7.25.jar -h ../baselineSeen/relexicalised_predictions-ter.txt -r ../baselineSeen/all-notdelex-refs-ter.txt
