...
java -Xmx2G -jar meteor-1.5.jar ../tripleFlatSeen/triple1/triple1_predictions.txt ../tripleFlatSeen/triple1/all-notdelex-refs-meteor.txt -l en -norm -r 3
...
java -jar tercom.7.25.jar -h ../tripleFlatSeen/triple1/relexicalised_predictions-ter.txt -r ../tripleFlatSeen/triple1/all-notdelex-refs-ter.txt
