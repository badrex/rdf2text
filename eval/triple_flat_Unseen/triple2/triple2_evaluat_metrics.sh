...
java -Xmx2G -jar meteor-1.5.jar ../triple_flat_Unseen/triple2/triple2_predictions.txt ../triple_flat_Unseen/triple2/all-notdelex-refs-meteor.txt -l en -norm -r 3
...
java -jar tercom.7.25.jar -h ../triple_flat_Unseen/triple2/relexicalised_predictions-ter.txt -r ../triple_flat_Unseen/triple2/all-notdelex-refs-ter.txt
