...
# get triple5 score
    ...
    with doc.create(Section('The evaluation scores for input data of various length for Unseen dataset')):
        doc.append(italic('========================================\n'))
        doc.append('Comparing the evaluation scores between two model: (flat, modify baseline) according to different triple size in Unseen dataset.\n')
...
# Generate TER score table
    ...
    #doc.generate_tex('TripleSize_Unseen_SetEvaluation')#Generate a .tex file for the document.
