...
printf " \n Blue score \n "
./multi-bleu.perl ${TEST_TARGETS_REF0} ${TEST_TARGETS_REF1} ${TEST_TARGETS_REF2} ${TEST_TARGETS_REF3} ${TEST_TARGETS_REF4} ${TEST_TARGETS_REF5} ${TEST_TARGETS_REF6}  < relexicalised_predictions.txt
...
java -Xmx2G -jar meteor-1.5.jar ../Category_Baseline_Seen/dev_Astronaut/relexicalised_predictions.txt ../Category_Baseline_Seen/dev_Astronaut/all-notdelex-refs-meteor.txt -l en -norm -r 7
...
java -jar tercom.7.25.jar -h ../Category_Baseline_Seen/dev_Astronaut/relexicalised_predictions-ter.txt -r ../Category_Baseline_Seen/dev_Astronaut/all-notdelex-refs-ter.txt
