...
printf "\n Meteor score \n"
#compute METEOR
java -Xmx2G -jar meteor-1.5.jar ../baseline/dev_triple3/relexicalised_predictions3.txt ../baseline/dev_triple3/all-notdelex-refs-meteor.txt -l en -norm -r 4

cd ..
cd tercom-0.7.25
printf "\n TER score \n"
#compute TER
java -jar tercom.7.25.jar -h ../baseline/dev_triple3/relexicalised_predictions-ter.txt -r ../baseline/dev_triple3/all-notdelex-refs-ter.txt
