...
java -Xmx2G -jar meteor-1.5.jar ../baseline/dev_triple1/relexicalised_predictions1.txt ../baseline/dev_triple1/all-notdelex-refs-meteor.txt -l en -norm -r 8
...
java -jar tercom.7.25.jar -h ../baseline/dev_triple1/relexicalised_predictions-ter.txt -r ../baseline/dev_triple1/all-notdelex-refs-ter.txt
