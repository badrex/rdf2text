...
printf "\n Meteor score \n"
#compute METEOR
java -Xmx2G -jar meteor-1.5.jar ../tripleBaselineSeen/dev_triple2/relexicalised_predictions2.txt ../tripleBaselineSeen/dev_triple2/all-notdelex-refs-meteor.txt -l en -norm -r 7

cd ..
cd tercom-0.7.25
printf "\n TER score \n"
#compute TER
java -jar tercom.7.25.jar -h ../tripleBaselineSeen/dev_triple2/relexicalised_predictions-ter.txt -r ../tripleBaselineSeen/dev_triple2/all-notdelex-refs-ter.txt
